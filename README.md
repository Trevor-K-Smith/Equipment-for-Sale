...
| Component | Details |
|-----------|---------|
| **Chassis** | GIGABYTE G292-Z45-00, 2U, 2x redundant PSU ([details](server-1/chassis-info/), [datasheet](server-1/chassis-info/GIGABYTE-G292-Z45-datasheet.pdf)) |
| **CPU 1** | AMD EPYC Rome 7742 ES — 64 cores — **0 MCE errors** ([details](server-1/cpu-info/), [datasheet](server-1/cpu-info/AMD-EPYC-7002-Series-datasheet.pdf)) |
| **CPU 2** | AMD EPYC Rome 7742 ES — 64 cores — **0 MCE errors** ([details](server-1/cpu-info/), [datasheet](server-1/cpu-info/AMD-EPYC-7002-Series-datasheet.pdf)) |
| **RAM** | 16x Samsung M393AAG40M32-CAE 128 GB (2 TB total) — **0 ECC errors** ([details](server-1/ram-health/), [datasheet](server-1/ram-health/Samsung-M393AAG40M32-128GB-DDR4-datasheet.pdf)) |
| **GPU 1** | NVIDIA RTX A5000 — **0 errors** ([details](server-1/gpu-health/gpu-1-rtx-a5000.txt), [datasheet](server-1/gpu-health/NVIDIA-RTX-A5000-datasheet.pdf)) |
| **GPU 2** | NVIDIA RTX A5000 — **0 errors** ([details](server-1/gpu-health/gpu-2-rtx-a5000.txt), [datasheet](server-1/gpu-health/NVIDIA-RTX-A5000-datasheet.pdf)) |
| **GPU 3** | NVIDIA RTX A5000 — **0 errors** ([details](server-1/gpu-health/gpu-3-rtx-a5000.txt), [datasheet](server-1/gpu-health/NVIDIA-RTX-A5000-datasheet.pdf)) |
| **GPU 4** | NVIDIA RTX A5000 — **0 errors** ([details](server-1/gpu-health/gpu-4-rtx-a5000.txt), [datasheet](server-1/gpu-health/NVIDIA-RTX-A5000-datasheet.pdf)) |
| **GPU 5** | NVIDIA RTX A5000 — **0 errors** ([details](server-1/gpu-health/gpu-5-rtx-a5000.txt), [datasheet](server-1/gpu-health/NVIDIA-RTX-A5000-datasheet.pdf)) |
| **Storage (NVMe)** | Samsung PM1733a 12.8 TB — **99% life remaining** ([details](server-1/disk-health/samsung-pm1733a-12.8tb-nvme.txt), [datasheet](server-1/disk-health/Samsung-PM1733a-NVMe-datasheet.pdf)) |
| **Storage (SATA)** | Samsung 870 QVO 8 TB — **98% life remaining** ([details](server-1/disk-health/samsung-870-qvo-8tb-sata.txt), [datasheet](server-1/disk-health/Samsung-870-QVO-datasheet.pdf)) |
